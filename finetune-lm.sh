...
$PY train.py --log ./logs/${logprefix}-train.log --batch_size 128 --nworkers $nworkers --datasets $datasets --logprefix $logprefix --data_dir ${data_dir} --saved_dir $saved_dir --epochs $epochs --initial_epoch $initial_epoch --lr $lr --pretrain /datasets/shshi/checkpoint-aishell/thchs30-aishell_model_197.hdf5 --training_models lm
