...
saved_dir=/home/comp/15485625/checkpoints/hvtrain
...
$MPIPATH/bin/mpirun --oversubscribe --prefix $MPIPATH -np $nworkers -hostfile cluster$nworkers -bind-to none -map-by slot \
    ...
    $PY hv_train_am.py --log ./logs/${logprefix}-train.log --batch_size 32 --nworkers $nworkers --datasets $datasets --logprefix $logprefix --data_dir ${data_dir} --saved_dir $saved_dir --epochs $epochs --initial_epoch $initial_epoch --lr $lr
